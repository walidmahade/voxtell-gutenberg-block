...
registerBlockType("cgb/faq-hero", {
    title: __("FAQ Hero"),
    icon: "edit",
    category: "faq",
    keywords: [__("FAQ"), __("Hero")],
    attributes: {
        secTitle: {
            type: "string",
        ...
        subTitle: {
            type: "string",
            default: "Don’t see an opportunity that fits your amazing skill set? We still want to hear from you! Apply here."
        }
    },
