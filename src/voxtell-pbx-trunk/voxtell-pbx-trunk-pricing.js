...
registerBlockType("cgb/voxtell-pbx-trunk-pricing", {
    title: __( "VoxTell PBX Trunk Pricing" ),
    icon: "edit",
    category: "what-we-do",
    keywords: [ __( "PBX" ), __( "Trunk" ), __("Pricing") ],
    attributes: {
        text1: {
            type: "string",
    ...
    edit: props => {
        ...
        return(
            <section id="pbx-price-plans" className="section">
                <InspectorControls>
                    <div>
                ...
                <div className="container">
                    ...
                    <div className="row pbx-price-boxes-row">
